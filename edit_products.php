    ...
    <div class="itembase">
      <div class="column">
        ...
        for($i = 0; $i<$numRows; $i++){
          ...
          echo "ID: " , $inventoryData['id'];
          echo "<br>";
          echo "Name: " , $inventoryData['name'];
          echo "<br>";
          echo "Price: " , $inventoryData['price'],"$";
          echo "<br>";
          echo "Description: " , $inventoryData['description'];
          echo "<br>";
          echo "Quantity: " , $inventoryData['quantity'];
          echo "<br>";
          echo "<br>";
        }
        ?>
      ...
      <div class="column">
        ...
        <form action="edit_products.php" method="post" id="productForm">
